...
class Block_Class(object):
    ...
    def draw(self):
        """   Draw the block from shape blocks. Each shape block  is filled with a color and black border     """
    ...
    def get_rotated(self,x,y):
        ...
        # Use the classic transformation matrix        rads = self.diff_rotation * (math.pi / 180.0)
    ...
    def remove_blocks(self,y):
        ...
        for shape_i in range(len(self.shape)):
            ...
            if tmp_shape.y < y:
                # Block is above the y, move down and add it to the list of active shape blocks.
    ...
    def _update(self):
        ...
        # Everyhting was moved. Setup new x,y, coordinates and reset all disable the move variables.
        self.x += self.diffx
        self.y += self.diffy
        self.diffx = 0
        self.diffy = 0
    ...
    def backup(self):
        ...
        # Make the deep copy of the shape list. Recall the current configuration.
